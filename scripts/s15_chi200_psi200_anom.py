# -*- coding: utf-8 -*-
"""
s15 - CHI200 (shaded + vento divergente) + PSI200 (contour).

Combina o campo de função de velocidade (CHI200) em shaded com vetores do
vento divergente e as isolinhas da função de corrente (PSI200) em azul escuro,
a partir dos NetCDFs preparados pelos pipelines plot_chi200 e plot_psi200.
...
def main():
    ...
    da_chi = _standardize_coords(_pick_first_var(ds_chi, CHI_CANDIDATES)[0])
    ...
    chi_varname = _pick_first_var(ds_chi, CHI_CANDIDATES)[1]
    ...
    for area in lst_areas:
        ...
        lon_q, lat_q, u_q_mask, v_q_mask = _prepare_quiver_masked(
            lon=lon_cyc_uv, lat=lat_chi, u=uchi_cyc, v=vchi_cyc,
            step=int(qcfg['step']),
