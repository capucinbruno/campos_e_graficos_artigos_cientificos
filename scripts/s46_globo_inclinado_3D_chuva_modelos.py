...
# os vídeos de CHUVA (acumulados de precipitação) do s44, cada um com sua própria config
...
#   - Variável: VARIAVEIS_GLOBO_3D em scripts/config_local/s46_globo_inclinado_3D_chuva_modelos.toml
...
def _get_variaveis() -> list[str]:
    """Lista de variaveis do s46, vinda do VARIAVEIS_GLOBO_3D da config local do script (que sobrepoe
    ...
    if not variaveis:
        raise ValueError(
            'Nenhuma variavel definida para o s46. Preencha VARIAVEIS_GLOBO_3D no arquivo '
            'scripts/config_local/s46_globo_inclinado_3D_chuva_modelos.toml — pelo menos UMA variavel '
