# -*- coding: utf-8 -*-
"""s38 - Globo 3D animado (midia) estilo Ben Noll: voo da camera + evolucao temporal.
...
def main():
    ...
    cache_params = {
        ...
        'script_version': '2.51',  # caixa Niño 3.4 vira flag de settings (GLOBO_3D_BOX_NINO34) p/ qualquer variavel
    }
