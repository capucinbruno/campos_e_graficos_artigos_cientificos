...
def check_cache_valid(
    script_name: str, params: Dict[str, Any], output_files: List[str], cache_dir: str = 'logs/cache'
) -> bool:
    """
    ...
    if cached_hash != current_hash:
        logger.debug('Cache inválido: parâmetros diferentes')
    ...
    if last_execution:
        ...
        logger.debug('Cache válido! (sem data de execução registrada)')
...
if __name__ == '__main__':
    ...
    print('   ✅ Esperado: False (primeira vez)\n')
    ...
    is_valid = check_cache_valid('test', params1, output_files)
    print(f'   Cache válido: {is_valid}')
    print('   ✅ Esperado: False (arquivo não existe)\n')
    ...
    is_valid = check_cache_valid('test', params1, output_files)
    print(f'   Cache válido: {is_valid}')
    print('   ✅ Esperado: True (tudo OK agora)\n')
    ...
    print(f'   Cache válido: {is_valid}')
    print('   ✅ Esperado: False (parâmetros diferentes)\n')
